                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Welcome to RevelMoney!</div>
                        </div>
                        ...
                        <div>
                            ...
                            <i *ngIf="invalidCredentials" class="text-orange-500">Credenziali errate</i>
                            </div>
                            <p-button label="Sign In" styleClass="w-full" routerLink="/" (onClick)="login()"></p-button>
                        </div>
                    </div>
                </div>
            </div>
